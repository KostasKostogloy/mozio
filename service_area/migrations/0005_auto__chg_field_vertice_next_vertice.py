...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Vertice.next_vertice'
        db.alter_column('service_area_vertice', 'next_vertice_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['service_area.Vertice']))

    def backwards(self, orm):

        # Changing field 'Vertice.next_vertice'
        db.alter_column('service_area_vertice', 'next_vertice_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['service_area.Vertice'], default=2))
    ...
    models = {
        ...
        'service_area.vertice': {
            ...
            'next_vertice': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'to': "orm['service_area.Vertice']", 'blank': 'True'}),
